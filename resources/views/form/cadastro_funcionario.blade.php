...
<div>
  ...
  <div data-mdb-input-init class="form-outline mb-4">
      <input type="text" name="input_nome_funcionario"
    ...
    <div data-mdb-input-init class="form-outline mb-4">
      <input type="email" name="input_email_funcionario"
    ...
    <div data-mdb-input-init class="form-outline mb-4">
      <input type="password" name="input_password_funcionario"
    ...
    <div data-mdb-input-init class="form-outline mb-4">
      <input type="text" name="input_CPF_funcionario" 
    ...
    <div data-mdb-input-init class="form-outline mb-4">
      <input type="date" name="input_nascimento_funcionario" 
